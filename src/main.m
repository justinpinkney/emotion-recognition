...
%     logger = kifu.Logger('fer2013plus', '', true, note);
    ...
    labelCounts = train.countEachLabel;
    labelWeights = labelCounts.Count/sum(labelCounts.Count);
    labelWeights = mean(labelWeights)./labelWeights;
    layers = makeWeightedBarsoumNet(imageSize, cellstr(labelCounts.Label), sqrt(labelWeights));

    options = trainingOptions('adam', ...
                            'ExecutionEnvironment', 'gpu', ...
                            'MiniBatchSize', 128, ...
                            'MaxEpochs', 60, ...
                            'InitialLearnRate', 0.001/10, ...
